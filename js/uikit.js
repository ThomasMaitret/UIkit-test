...
}(this, (function($$1)
{
	...
	{
		return strats.args(parentVal, $$1.isFunction(childVal) ?
		{
			write: childVal
		} : childVal);
	};
...

				{
					...
					read: function read()
					{
						...
						if(this.scroll)
						{
							...
							{
								return UIkit.scroll(el,
								{
									offset: this$1.offset || 0
								});
							});
						}
					}
